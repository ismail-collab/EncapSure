...
<form action="UploadFiles" method="POST" enctype="multipart/form-data">
    ...
    <div>
    <span > Tech visit : </span>
    <input type="file" name="tech" required>
    </div>
    <div>
    <?php $i=0 ?>
    ...
    <input type="hidden" name="infos[<?php echo e($i++); ?>]" value="<?php echo e($info['contract_num']); ?>-<?php echo e($info['receipt']); ?>">
...
</html><?php /**PATH C:\xampp\htdocs\InsucranceFrontEnd\InsucranceFrontEnd\project\resources\views/ClientUploadPage.blade.php ENDPATH**/ ?>