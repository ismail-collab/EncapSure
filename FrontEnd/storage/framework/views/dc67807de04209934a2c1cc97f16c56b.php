...
<tr>
    <?php $i=1  ?>
    <?php $__currentLoopData = $RECPS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr>
    <input type="hidden" name="recps[<?php echo e($i++); ?>]" value="<?php echo e($rec['id']); ?>-<?php echo e($rec['receipt']); ?>-<?php echo e($rec['contract_num']); ?>-<?php echo e($rec['left_amount']); ?>">
    <td><?php echo e($rec['contract_num']); ?></td>
    <td><?php echo e($rec['receipt']); ?></td>
    <td><?php echo e($rec['left_amount']); ?></td>
    </tr>
...
</html><?php /**PATH C:\xampp\htdocs\InsucranceFrontEnd\InsucranceFrontEnd\project\resources\views/ClientAdressPage.blade.php ENDPATH**/ ?>