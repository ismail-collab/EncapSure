...
<!--fel user Controller n7otha thezni lel page ? no -->
    ...
    <table id="users-table">
        ...
        <tr>
            ...
            <td><input type="checkbox" id="pick" name="selection" value="<?php echo e($user->username); ?>"></td>
...
<?php /**PATH C:\xampp\htdocs\InsucranceFrontEnd\InsucranceFrontEnd\project\resources\views/AdminCRUD.blade.php ENDPATH**/ ?>