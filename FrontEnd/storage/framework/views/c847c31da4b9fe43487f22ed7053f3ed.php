...
<div class="container">
    <h2><i class="fas fa-shield-alt"></i> Modifiez votre pack</h2>
    <div class="Forms" id="F3">
        <!-- Form Card -->
        <div>
            <form id="pack-form" action="editpack" method="POST">
                <?php echo csrf_field(); ?>
                <div class="form-group">
                    <label for="pack-name"><i class="fas fa-tag"></i> Nom du Pack :</label>
                    <input type="hidden" id="pack-id" name="pack_id" value="" class="form-control" required>
                    <input type="text" id="pack-name" name="pack_name" value="" class="form-control" required>
                </div>

                <div class="form-group">
                    <label for="pack-price"><i class="fas fa-dollar-sign"></i> Prix du Pack :</label>
                    <input type="number" id="pack-price" name="price" class="form-control" value="" readonly required>
                </div>

                <div class="form-group">
                    <label><i class="fas fa-shield-alt"></i> Garanties :</label>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="guarantees[1]" id="gr1" value="1" >
                        <label class="form-check-label" for="responsabilite-civile">
                            Responsabilité civile
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="guarantees[2]" id="gr2" value="2" >
                        <label class="form-check-label" for="assistance-24-7">
                            Assistance 24/7
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="guarantees[3]" id="gr3" value="3" >
                        <label class="form-check-label" for="protection-juridique">
                            Protection juridique
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="guarantees[4]" id="gr4" value="4" >
                        <label class="form-check-label" for="garantie-dommages">
                            Garantie dommages
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="guarantees[5]" id="gr5" value="5" >
                        <label class="form-check-label" for="vol-et-incendie">
                            Vol et incendie
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="guarantees[6]" id="gr6" value="6" >
                        <label class="form-check-label" for="assurance-tous-risques">
                            Assurance tous risques
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="guarantees[7]" id="gr7" value="7" >
...
<script defer>
    ...
    var pack_id = document.getElementById('pack-id');
    var packName = document.getElementById('pack-name');
       
        var packId = sessionStorage.getItem('pack_id');
        console.log(packId);
        var packname = sessionStorage.getItem('packName');
        var packPrice = sessionStorage.getItem('price');
        var Grr1 = sessionStorage.getItem('gr1');
        var Grr2 = sessionStorage.getItem('gr2');
        var Grr3 = sessionStorage.getItem('gr3');
        var Grr4 = sessionStorage.getItem('gr4');
        var Grr5 = sessionStorage.getItem('gr5');
        var Grr6 = sessionStorage.getItem('gr6');
        var Grr7 = sessionStorage.getItem('gr7');
        console.log(typeof(Grr1),Grr2,Grr3,Grr4,Grr5,Grr6,Grr7);

    pack_id.value = packId;
    packName.value = packname;
    price.value = packPrice;
...
<?php /**PATH C:\xampp\htdocs\InsucranceFrontEnd\InsucranceFrontEnd\project\resources\views/EditPack.blade.php ENDPATH**/ ?>