...
<?php $__currentLoopData = $DEVIS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dev): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<?php if ($dev!=null) {  ?>


  <section>

  <iframe id="frame" height="740" width="700" src="data:application/pdf;base64,<?php echo e($dev->devis_doc); ?>" ></iframe>
  ...
  <button  id="del_btn" onClick="DeleteDevis(<?php echo e($dev->devis_id); ?>)"> Supprimer le devis</button>
...
</html><?php /**PATH C:\xampp\htdocs\InsucranceFrontEnd\InsucranceFrontEnd\project\resources\views/SubsDevisShow.blade.php ENDPATH**/ ?>