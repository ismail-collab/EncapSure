...
<div class="client-header">
  <h1 class="text-center mb-5 interactive client-text"><i class="fas fa-home"></i> Home Admin</h1>
</div>
...
<div class="row d-flex justify-content-between">
    <div class="col-md-6 col-lg">
        <div class="card text-center p-4">
            <a href="AdminDashboard"><i class="icon fas fa-tachometer-alt"></i></a>
    ...
    <div class="col-md-6 col-lg">
        <div class="card text-center p-4">
            <a href="AdminCRUD"><i class="icon fas fa-users-cog"></i></a>
    ...
    <div class="col-md-6 col-lg">
        <div class="card text-center p-4">
            <a href="GererPack"><i class="icon fas fa-shield-alt"></i></a>
            <h3>Gérer packs</h3>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\InsucranceFrontEnd\InsucranceFrontEnd\project\resources\views/HomeAdmin.blade.php ENDPATH**/ ?>