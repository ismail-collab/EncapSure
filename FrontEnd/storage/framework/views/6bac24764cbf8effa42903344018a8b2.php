...
<div class="client-header">
        <h1 class="text-center mb-5 interactive client-text"> <i class="fas fa-user-shield"></i> Gestion des souscriptions clients</h1>
        </div>
...
</html><?php /**PATH C:\xampp\htdocs\InsucranceFrontEnd\InsucranceFrontEnd\project\resources\views/AdminDevisSouscription.blade.php ENDPATH**/ ?>